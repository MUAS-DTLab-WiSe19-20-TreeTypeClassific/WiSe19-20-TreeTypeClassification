...
def parse_args():
    ...
    parser.add_argument(
        "-num_points", type=int, default=2048, help="Number of points to train with"  # 4096
    )
    parser.add_argument(
...
lr_clip = 1e-5
bnm_clip = 1e-2
additional_data = False  # roessl:changed
...
if __name__ == "__main__":
    ...
    test_set = ModelNet40Cls(args.num_points, transforms=transforms, train=False, additional_data=additional_data)
    ...
    train_set = ModelNet40Cls(args.num_points, transforms=transforms, additional_data=additional_data)
    ...
    bl = trainer.train(
        ...
        folder="/home/pflab/Desktop/Roessl/Pointnet++/Pytorch/Pointnet2_PyTorch-master/pointnet2/result/ModelNet40"
    )
    print("Best loss %f" % bl)
