...
class PointcloudRotate(object):
    # def __init__(self, axis=np.array([0.0, 1.0, 0.0])):   # TODO roessl
    ...
    def __call__(self, points):
        ...
        normals = points.size(1) > 5  # roessl changed 3-5
        # normals = False
        ...
        if not normals:
            ...
            pc_xyz = points[:, 0:3]
            # pc_normals = points[:, 3:]    # TODO roessl
...
class PointcloudRandomInputDropout(object):
    def __init__(self, max_dropout_ratio=0.100):  # 0.875
